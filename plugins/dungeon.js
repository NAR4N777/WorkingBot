...
`.trim()
      ...
      setTimeout(async () => {
        ...
        let { exp, money, tiketcoin, sampah, potion, diamond, iron, kayu, batu, string, common, uncommon, mythic, legendary, pet, makananPet } = room.price  
        let str2 = `
❤️Nyawa Kamu berkurang -${health * 1}, dan durability ⚔️Sword Kamu -${sword * 1} karena kamu telah Membunuh ${pickRandom(['Ender Dragon', 'Baby Dragon', 'Titan', 'Cacing dan Semut', 'PP Mikey', 'Orang', 'Kecoa', 'Semut', 'Siput', 'Alok', 'Wither', 'Sekeleton', 'Ayam Emas', 'Temenmu', 'Sapi', 'Kominfo', 'Creeper', 'Zombie', 'Hewan Pelihraanmu','Diri Sendiri'])} dan mendapatkan
*✉️exp:* ${exp}
*💵uang:* ${money}
*🎫tiketcoin:* ${tiketcoin * 1}
